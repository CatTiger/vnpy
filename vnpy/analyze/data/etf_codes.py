...
etf_set = [
    ...
    IndexInfo('399437.XSHE', '国证证券行业指数', '512880', datetime(2014, 12, 30), IndexType.INDUSTRY),
    IndexInfo('399967.XSHE', '中证军工', '512660', datetime(2013, 12, 26), IndexType.INDUSTRY),
    ...
    IndexInfo('399971.XSHE', '中证传媒', '512980', datetime(2014, 4, 11), IndexType.INDUSTRY),
